    ...
    public void registerComponents(@NonNull Context context, @NonNull Glide glide, @NonNull Registry registry) {
        OkHttpClient client = new OkHttpClient.Builder()
                ...
                .addInterceptor(chain -> {
                    ...
                    // Build new request with standard headers to avoid 403 Forbidden from strict hosts (e.g., Wikipedia)
                    Request.Builder builder = original.newBuilder()
                            // Using a modern, widely accepted browser User-Agent
                    ...
                    if (original.url().host().contains("firebasestorage.googleapis.com")) {
                        try {
                    ...
                    if (response.code() == 403) {
                        Log.w("BirdDexGlideModule", "403 Forbidden for URL: " + original.url());
                    }
