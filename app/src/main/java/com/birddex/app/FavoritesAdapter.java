...
public class FavoritesAdapter extends RecyclerView.Adapter<FavoritesAdapter.VH> {
    ...
    public FavoritesAdapter(@Nullable List<CollectionSlot> items,
                            @Nullable OnFavoriteSlotClickListener listener) {
        this.listener = listener;
        setSlots(items);
    }

    public void setSlots(@Nullable List<CollectionSlot> items) {
        slots.clear();

        if (items != null) {
            for (CollectionSlot slot : items) {
    ...
    @NonNull
    @Override
    public FavoritesAdapter.VH onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull FavoritesAdapter.VH holder, int position) {
